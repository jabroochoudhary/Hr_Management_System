        ...
        children: [
          Container(
            ...
            child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(context, CustomTransition(EditProfile()));
                    ...
                    Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(context, CustomTransition(SignupScreen()));
                          },
              ...
              Container(
                padding: EdgeInsets.symmetric(horizontal: SizeConfig.widthMultiplier*14,vertical: 40),
                child: CustomButton(
                  callback: () {
                    Get.back();
                  },
